...
def showResult(t1_data, result):
    ...
    if isDebug:
        ...
        axarr[0,0].imshow(result[random_slices[0]])
        axarr[0,1].imshow(result[random_slices[1]])
        axarr[1,0].imshow(result[random_slices[2]])
        axarr[1,1].imshow(result[random_slices[3]])
        plt.show()
    return
